...
export class CreateTables1747500715487 implements MigrationInterface {
    name = 'CreateTables1747500715487'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "weather" ("id" SERIAL NOT NULL, "temperature" integer, "humidity" integer, "description" character varying, CONSTRAINT "PK_af9937471586e6798a5e4865f2d" PRIMARY KEY ("id"))`);
